                      ...
                      >
                        <div className="flex flex-wrap items-start justify-between gap-2">
                          <div className="flex flex-wrap items-center gap-2">
                            ...
                            {rule.bill_number && (
                              <a
                                href={`/proposals/${rule.id}`}
                                className="rounded bg-gray-100 px-2 py-0.5 font-mono text-xs text-gray-600 hover:bg-indigo-50 hover:text-indigo-700 transition-colors"
                              >
                                {rule.bill_number}
                              </a>
                            )}
                            {rule.regulations_gov_id && (
                              <a
                                href={`https://www.regulations.gov/document/${rule.regulations_gov_id}`}
                                target="_blank"
                                rel="noopener noreferrer"
                                className="rounded bg-gray-100 px-2 py-0.5 font-mono text-xs text-gray-600 hover:bg-indigo-50 hover:text-indigo-700 transition-colors"
                              >
